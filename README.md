...
前端能力保留 → Java 后端基础 → 数据库与接口 → Spring Boot 项目 → AI 接入 → 知识库问答 → Python AI 工具线 → Agent 能力 → 完整 AI 全栈作品 → 部署上线
...
### 📍 第八站：Python AI 工具线（约 2 周）

- 学习 Python 在 AI 场景里的实用能力，不替代 Java 主线
- 重点练习文档处理、RAG 原型、MCP 工具服务和 Agent 原型
- 🏆 **通关标志**：完成一个“AI 工具实验箱”，能辅助 Java 项目做 AI 能力验证

### 📍 第九站：完整 AI 全栈项目（约 2 周）
...
| 第六站 | AI 接入 | 2 周 |
| 第七站 | 知识库问答 RAG | 3 周 |
| 第八站 | Python AI 工具线 | 2 周 |
| 第九站 | 完整 AI 全栈项目 | 2 周 |
| 第十站 | Linux / Docker 部署 | 1~2 周 |
| **合计** | **从前端到 AI 全栈作品上线** | **约 4 个月** |
